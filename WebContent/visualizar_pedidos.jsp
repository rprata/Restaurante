...
<title>Página Inicial - Cozinha</title>
	...
	<div id="wrapper">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				<li><a href="inicio_coz.jsp"><i class="fa fa-dashboard"></i>
						Início</a></li>
				<li><a href="visualizar_pedidos.jsp"><i
						class="fa fa-bar-chart-o"></i> Visualizar Pedidos</a></li>
			</ul>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><a href="inicio_coz.jsp"><i class="icon-dashboard"></i>
								Página Inicial</a></li>
						<li class="active"><i class="icon-file-alt"></i> Visualizar
							Pedidos</li>
					</ol>
				</div>
			</div>
			...
			<table class="table table-hover table-striped tablesorter">
				...
				<tbody>
					<%
						...
						ArrayList<Pedido> pedidos = pedidoDAO.getTodosPedidosAndamento();
						...
						for (Pedido p : pedidos) {
							...
							String input = "<td><a href=\"manter_pedido.jsp?page=visualizar&type=Pronto&id=" + p.getId() + "\">Confirmar</a><a href=\"manter_pedido.jsp?type=Cancelado&id=" + p.getId() + "\"></br>Cancelar</a></td>";
							out.println(input);
							out.println("</tr>");

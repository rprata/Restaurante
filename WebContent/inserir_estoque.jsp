...
<body>
	...
	<div id="wrapper">
				...
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><i class="icon-file-alt"></i> Manter
							Estoque</li>
						<li class="active"><i class="icon-file-alt"></i> Novo Ingrediente</li>
					</ol>
				</div>
			</div>
			<!-- /.row -->
		...
		<div class="col-lg-6">
			...
			<form method="POST" action="manter_estoque_inserir.jsp">

				<div class="form-group">
					<label>Ingrediente</label> <input class="form-control"
						placeholder="Digite o nome do novo ingrediente" name="ingrediente">
				</div>
				...
				<label>Unidade</label> <input class="form-control"
						placeholder="Digite a unidade utilizada do novo ingrediente" type="text"
						name="unidade">
				</div>

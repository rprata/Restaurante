...
<body>
	...
	<div id="wrapper">
		...
		<div class="col-lg-6">
			...
			<form method="POST" action="manter_estoque_atualizar.jsp">

				<div class="form-group">
					<label>Ingrediente</label> <select class="form-control" name="ingrediente">
						<%
							EstoqueDAO estoqueDAO = new EstoqueDAO();
							ArrayList<Estoque> estoques = estoqueDAO.getTodoEstoque();

							for (Estoque e : estoques) {
								out.println("<option>" + e.getIngrediente() + "</option>");
							}
						%>
					</select>
				</div>

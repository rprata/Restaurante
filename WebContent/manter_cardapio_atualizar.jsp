...
<body>
	...
	<div id="wrapper">
		...
		<div class="col-lg-6">
			...
			<form method="POST" action="manter_cardapio_atualizar_final.jsp">
				<%
				...
				<div class="form-group">
					<label>Prato</label> <input class="form-control"
						...
						value="<%=c.getPrato()%>" name="prato" readonly="readonly">
				</div>

				<div class="form-group">
					<label>Preço</label> <input class="form-control"
						placeholder="Digite o valor do novo prato" type="text"
						value="<%=c.getPreco()%>" name="preco">
				</div>

				<div class="form-group">
					<label>Descrição</label>
					<textarea class="form-control"
						placeholder="Digite a descrição do novo prato" rows="5"
						name="descricao"><%=c.getDescricao()%></textarea>
				</div>

				<div class="form-group">
					<label>Receita</label>
					<textarea class="form-control" rows="8"
						placeholder="Digite a receita do novo prato" name="receita"><%=c.getReceita()%></textarea>
				</div>

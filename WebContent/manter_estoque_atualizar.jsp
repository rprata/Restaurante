...
<body>
	...
	<div id="wrapper">
		...
		<div class="col-lg-6">
			...
			<form method="POST" action="manter_estoque_atualizar_final.jsp">
				<%
					String ingrediente = request.getParameter("ingrediente");
					EstoqueDAO estoqueDAO = new EstoqueDAO();
					Estoque e = estoqueDAO.getDadosEstoque(ingrediente);
				%>

				<div class="form-group">
					<label>Ingrediente</label> <input class="form-control"
						placeholder="Digite o nome do novo ingrediente"
						value="<%=e.getIngrediente()%>" name="ingrediente"
						readonly="readonly">
				</div>

				<div class="form-group">
					<label>Quantidade</label> <input class="form-control"
						placeholder="Digite a quantidade do novo ingrediente" type="text"
						value="<%=e.getQuantidade()%>" name="quantidade">

				</div>

				<div class="form-group">
					<label>Unidade</label> <input class="form-control"
						placeholder="Digite a unidade utilizada do novo ingrediente"
						value="<%=e.getUnidades()%>" type=" text" name="unidade"
						readonly="readonly">
				</div>

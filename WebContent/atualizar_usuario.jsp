...
<body>
	...
	<div id="wrapper">
				...
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><i class="icon-file-alt"></i> Manter
							Usuário</li>
						<li class="active"><i class="icon-file-alt"></i> Atualizar Usuário</li>
					</ol>
				</div>
			</div>
			<!-- /.row -->
		...
		<div class="col-lg-6">
			...
			<form method="POST" action="manter_usuario_atualizar.jsp">

				<div class="form-group">
					<label>Usuário</label> <select class="form-control" name="login">
						<%
							UsuarioDAO usuarioDAO = new UsuarioDAO();
							ArrayList<Usuario> usuarios = usuarioDAO.getTodosElementos();

							for (Usuario u : usuarios) {
								out.println("<option>" + u.getLogin() + "</option>");
							}
						%>
					</select>
				</div>
